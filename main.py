...
st.markdown("당신의 MBTI 유형을 선택하면 어울리는 직업을 추천해드립니다!")
...
with st.expander("💡 MBTI와 진로 선택 팁 보기"):
    st.markdown("""
    - MBTI는 자기 이해를 돕는 도구일 뿐, 진로를 제한하는 기준이 아닙니다.
    - 실제 직업 선택 시 **관심사, 가치관, 기술**도 함께 고려하세요.
    - 다양한 경험을 통해 자신에게 맞는 길을 찾아가세요!
    """)
